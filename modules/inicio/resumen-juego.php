...
<div class="fondo">
    <div class="columna-1">
        ...
        <div class="fila2-cl1">
            ...
            <a href="<?php echo (isset($row['perfil']) && $row['perfil'] == 'profesor') ? 'reporte-niveles.php' : 'informacion.php'; ?>"
               class="lg-cl1">
                <img src="../../assets/img/inicio/<?php echo (isset($row['perfil']) && $row['perfil'] == 'profesor') ? 'report.png' : 'info.png'; ?>"
                     alt="">
                ...
                <div class="btn-juego-principal">
                    ...
                    <div class="score-container">
                        <div class="score-content">
                            <a class="btn_practica" href="juego-nivel1.php">Volver al juego</a>
                        </div>
                    </div>
                </div>
            </div>
