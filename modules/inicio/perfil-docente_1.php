                            ...
                            <div class="cont-prin">
                                <div class="col-md-6 offset-md-3 search-container">
                                    ...
                                    <button type="button" class="btn btn-success mt-2" data-bs-toggle="modal"
                                            data-bs-target="#registroModal"><?php echo $translations['create_button']; ?></button>
                                </div>
                                <form action="" method="post" enctype="multipart/form-data" class="mt-2">
                                    <input type="file" name="file" class="form-control" required>
                                    <button type="submit" name="import"
                                            class="btn btn-success mt-2"><?php echo $translations['import_button']; ?></button>
                                </form>
                            </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="requirementForm" name="requirementForm"
                                            ...
                                            <div class="mb-3">
                                                <label for="is_ambiguous"
                                                       class="form-label"><?php echo $translations['ambiguous_label']; ?></label>
                                                <select class="form-select" id="is_ambiguous" name="is_ambiguous"
                                                        required>
                                            ...
                                            <div class="mb-3">
                                                <label for="retro"
                                                       class="form-label"><?php echo $translations['retro_label']; ?></label>
                                                <textarea class="form-control" id="retro" name="retro" rows="3"
                                                          placeholder="<?php echo $translations['retro_label']; ?>"></textarea>
                                            </div>
                                            <button type="submit" class="btn btn-primary" name="insert"
                                                    id="insertButton"><?php echo $translations['create_button']; ?></button>
                                            <button type="submit" class="btn btn-primary" name="update"
                                                    id="updateButton"
                                                    style="display: none;"><?php echo $translations['edit_button']; ?></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <form id="requirementsForm" method="post" action="">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                            onclick="editRequirement('<?php echo $requirement['id']; ?>', '<?php echo htmlspecialchars($requirement['name'], ENT_QUOTES, 'UTF-8'); ?>', '<?php echo $requirement['is_ambiguous']; ?>', '<?php echo htmlspecialchars($requirement['retro'], ENT_QUOTES, 'UTF-8'); ?>')">
                                                        <i class="fas fa-edit"></i> <?php echo $translations['edit_button']; ?>
                                                    </button>
                                                    <form method="post"
                                                        ...
                                                        <button type="submit" name="delete"
                                                                class="btn btn-danger btn-sm"><i
                                                                    class="fas fa-trash"></i> <?php echo $translations['delete_button']; ?>
                                                        </button>
                                                    </form>
                                                </td>
                                                <td><input class="requirement-checkbox" type="checkbox"
                                                           name="requirements[]"
                                                           value="<?php echo $requirement['id']; ?>"></td>
                                            </tr>
                                        <?php endwhile; ?>
                                        </tbody>
                                    </table>
                                                ...
                                                <ul class="pagination justify-content-center">
                                                    ...
                                                    for ($i = $start; $i <= $end; $i++): ?>
                                                        <li class="page-item <?php if ($page == $i) {
                                                            ...
                                                            <a class="page-link"
                                                               href="?query=<?php echo $search_query; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                                        </li>
                                                    <?php endfor; ?>
                                    ...
                                    <div class="btn-generar-codigo">
                                        <button id="botongene" type="submit" class="btn btn-success mt-2"
                                                name="generate_code"><?php echo $translations['generate_code']; ?></button>
                                    </div>
