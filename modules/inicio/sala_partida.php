...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['gamePin'])) {
    ...
    $sql_room = "SELECT nivel FROM room_requirements1 WHERE room_code = '$gamePin'";
            ...
            <div class="fila1-cl2">
                ...
                <div class="usuario-logueado">
                    <div class="profile-data-item">
                        <span id="username" class="username-span"><?php echo htmlspecialchars($row["usuario"]); ?></span>
                    </div>
                    <?php
                    // Mostrar la imagen de perfil si está disponible
                    if (!empty($row["imagen_perfil"])) {
                        echo '<img class="profile-pic" src="' . htmlspecialchars($row["imagen_perfil"]) . '" alt="Imagen de perfil">';
                    } else {
