...
// Verificar si se ha pasado el código de la sala
...
$sql_count = "SELECT COUNT(*) as total 
              ...
              WHERE u.perfil = 'estudiante' AND p.nivel = 1";
...
if (!$result_count) {
    die("Error al obtener el conteo de registros: " . $con->error);
}
...
$sql_user = "SELECT usuario, imagen_perfil FROM usuarios WHERE id = ?";
                ...
                <div class="contenido-juego">
                    <div class="contenedor-ab">
                        <div class="text">
                            ...
                            <h2 class="text">Puntajes de los Estudiantes - Nivel 1</h2>
                        </div>
                        <div class="cont-form">
