...
<body>
    <div class="fondo">
    <div class="columna-1">
            <div class="fila1-cl1">                <select id="languageSelector">
                            ...
                            if($score > 0) {
                                ...
                                if(isset($_SESSION['usuario'])) {
                                    ...
                                    if(mysqli_num_rows($result_user) > 0) {
                                        ...
                                        // Obtener el room_code de la sesión
                                        ...
                                        $sql = "INSERT INTO puntajes (user_id, puntaje, nivel, room_code) VALUES ('$user_id', '$score', '2', '$room_code')";
                                        if(mysqli_query($con, $sql)) {
                                            ...
                                            if($score >= 1) { // Cambiar aquí el puntaje necesario para avanzar al siguiente nivel
                                                echo "<p class='message'>¡Felicidades! ¡Haz culminado el nivel 2!</p>";
                                                // Mostrar el botón solo si el puntaje es suficiente
                                                echo '<div class="score-container">';
                                                echo '<a class="button_siguiente" href="inicio.php">Inicio</a>';
                                                echo '</div>';
                                            } else {
